...
import { ReflectionComponent } from '../goals/reflection';
...
export const goalsRoutes: Routes = [
    ...
    { path: 'setup', loadComponent: () => import('../goals/setupFirstGoal/setupFirstGoal.component').then(c => c.SetupFirstGoalComponent) },
